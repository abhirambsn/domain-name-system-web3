...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Empire Domain Name Service", "EDNS") {
    ...
    function registerDomain(string calldata name) public payable {
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A Domain on Empire Domain Name Service", "image": "data:image/svg+xml;base64,',
    ...
    function getRecord(string calldata name, string calldata record)
        public
        view
